...
export type EcosystemProjectStatus =
  'live' | 'development' | 'planned' | 'future' | 'concept' | 'experimental';
...
export const ECOSYSTEM_PROJECTS = [
  ...
  {
    id: 'sentient-signals',
    label: 'Sentient Signals',
    name: 'Sentient Signals',
    category: 'ai',
    status: 'development',
  },
  {
  ...
  },
  {
    id: 'tvk-labs',
    label: 'TVK Labs',
    name: 'TVK Labs & Technologies',
    category: 'operations',
    status: 'live',
  },
  {
    id: 'tvk-group-tr',
    label: 'TVK Group Türkiye',
    name: 'TVK Group Türkiye',
    category: 'operations',
    status: 'live',
  },
  {
